...
console.log("the hits property is where the job results are stored is an Array")

// 3.3. In each hit of hits, how to find the job’s title, locations, salary, benefits, skills and requirements (based on Dũng's excersise)
console.log("3.3. In jobSearch ra màn hình console, xong tìm kiếm trên màn hình console(Ctrl+F).") 
